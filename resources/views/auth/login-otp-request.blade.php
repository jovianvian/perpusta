...
<div class="text-center mb-8">
    <h2 class="text-2xl font-bold text-white">Login dengan OTP Email</h2>
    <p class="text-slate-400 mt-2">Masukkan email akun, kami akan kirim kode OTP login.</p>
</div>
...
<form method="POST" action="{{ route('login.otp.send') }}" class="space-y-6">
    @csrf
    <div>
